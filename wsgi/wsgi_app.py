...
all_packages = ['vedavaapi_core', 'core_services', 'ullekhanam', 'iiif', 'image_analytics', 'loris', 'docimage', 'vedavaapi_api', 'sling', 'smaps', 'objectdb', 'sanskrit_data', 'sanskrit_ld', 'google_services_helper']
