...
all_package_dirs = ['vedavaapi_core', 'vedavaapi_api', 'docimage', 'core_services', 'ullekhanam', 'sling', 'smaps', 'objectdb', 'sanskrit_data']  # to be added to PYTHONPATH for this invocation. relative to root vedavaapi dir
